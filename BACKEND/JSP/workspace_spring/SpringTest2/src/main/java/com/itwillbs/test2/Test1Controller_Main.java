...
// 컨트롤러 역할을 수행할 클래스 TestController_Main 클래스 정의!
// => @Controller 어노테이션 선언 
@Controller
...
//	@RequestMapping(value="/main" ,method = {RequestMethod.GET, RequestMethod.POST})
	// value 속성도 String[] 타입이므로 복수개의 문자열을 활용하여 복수개의 경로 매핑도 가능ㄴ
	// 또한, 기본 속성이 value 속성이므로 속성이 1개일 경우 value 속성명도 생략 가능
//	@RequestMapping("/main")
	...
	// "test1" (GET) 매핑시 test/test1.jsp 페이지 포워딩 
...
//	}
	...
	// 스프링4.3 버전부터는 다른 어노테이션도 제공됨
	// => GET 방식 요청 매핑 전용 어노테이션 : @GetMapping
	// => PSOT 방식 요청 매핑 전용 어노테이션 : @PostMapping
