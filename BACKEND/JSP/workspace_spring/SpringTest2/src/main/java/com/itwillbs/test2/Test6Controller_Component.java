...
//		// => 주의! 이 출력문은 매핑 메서드 호출 시점이 아닌 서버가 시작될 때 호출되므로
...
//	}
	...
	// => 스프링 4.3 버전 이전 또는 스프링이 아닌 자바에서는 @Inject 어노테이션 사용 
	// 	  (대신, 별도의 라이브러리 (javax.inject) 추가 필요하지만,
	//    스프링 MVC는 기본적으로 추가되어 있음)
	@Autowired
	private Test6Component comp;
