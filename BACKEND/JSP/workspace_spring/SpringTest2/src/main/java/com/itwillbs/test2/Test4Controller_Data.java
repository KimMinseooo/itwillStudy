...
//		
//		System.out.println("name 파라미터 값 : "+name);
//		System.out.println("age 파라미터 값 : "+age);
//		System.out.println("gender 파라미터 값 : "+gender);
//		System.out.println("hiddenValue 파라미터 값 : "+hiddenValue);
//		
...
////		System.out.println("name 파라미터 값 : "+person.getName());
////		System.out.println("age 파라미터 값 : "+person.getAge());
////		System.out.println("gender 파라미터 값 : "+person.getGender());
//		System.out.println("hiddenValue 파라미터 값 : "+hiddenValue);
//		
//		
//		return "test2/data_result1";
