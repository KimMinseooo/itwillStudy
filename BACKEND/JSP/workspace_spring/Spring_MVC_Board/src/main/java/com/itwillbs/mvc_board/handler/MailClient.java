...
public class MailClient {
	...
	private final String SENDER_ADDRESS = "abcd@naver.com"; // 발신자 메일 주소 // 어차피 인증 서버로 보내질거라서 상관없음 (메일주소를 따로 만들어놓은것이 아니기 때문에)
	...
	public void sendMail(String receiver, String subject, String content) {
		...
		try {
			...
			props.put("mail.smtp.ssl.trust", HOST); // SSL 인증에 사용할 신뢰 가능한 서버 주소 
...
//			mailAuth
			...
			// 3) 5번 과정에서 생성한 MimeMesssage(Message) 객체를 활용하여 
			// 전송할 메일의 내용 설정
			// => MessagingException 예외처리 필요
