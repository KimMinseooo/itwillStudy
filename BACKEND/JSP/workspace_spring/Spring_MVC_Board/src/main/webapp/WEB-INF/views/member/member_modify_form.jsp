		...
		<form action="MemberModify" name="joinForm" method="post">
			<table border="1">
				...
				<tr>
					<th>아이디</th>
					<td>
						<input type="text" name="id" id="id" value="${member.id}" placeholder="4~16자 영문자,숫자,_조합" readonly>
				...
				<tr>
					...
					<td>
						...
						<select name="job">
							...
							<option value="DB엔지니어" <c:if test="${member.job eq '관리자'}">selected</c:if>>관리자</option>
						</select>
					</td>
				</tr>
				<tr>
