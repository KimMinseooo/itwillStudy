		...
		<form action="MemberJoin" name="joinForm" method="post">
			<table border="1">
				...
				<tr>
					<th>아이디</th>
					<td>
						<input type="text" name="id" id="id" placeholder="4~16자 영문자,숫자,_조합">
				...
				<tr>
					...
					<td>
						...
						=> 조합 대상 외의 문자가 포함되거나 길이가 부적합할 경우 
							"영문자, 숫자, 특수문자(!@#$%) 조합 8~16글자 필수!" 메세지를 span영역에 빨간색으로!
						=> 아니면 복잡도 검사를 체크하여 "안전","보통","위험","사용불가" 4단계 메시지 출력
						 -->
				...
				<tr>
					...
					<td>
						<select name="job">
							...
							<option value="DB엔지니어">관리자</option>
						</select>
					</td>
				</tr>
				<tr>
