...
public class HomeController {
	...
	/**
	 *	@RequestMapping 어노테이션을 적용하여 요청URL에 대한 매핑 수행
	 * 	- 기본 문법 : @RequestMapping(value = "매핑URL", method = RequestMethod.XXX)
	 * 				public 리턴타입 메서드명([파라미터....]){}
	 * 	=> value 속성은 매핑에 사용될 매핑URL을 문자열로 지정하고
	 * 	   method 속성은 RequestMethod라는 enum 타입의 값으로 GET, POST , PUT, DELETE 등의 요청 메서드
...
//		return "home";  // webapp/WEB-INF/views/home.jsp 페이지로 포워딩(디스패치 방식)
	...
	public String test() {
		System.out.println("/test 요청 호출 완료!!!!!!!!");
...
//	 ============================================================
//	 "/BoardWrite" 서블릿 주소(GET)와 매핑되는 boardWrite()메서드정의
