...
<body>
	...
	<%-- 현재 요청 주소의 최상위 경로에서 myServlet3 서블릿을 요청하게 된다! --%>
	<form action="/myServlet3" method="get">
		<input type="submit" value="/myServlet3 요청(GET)">
	</form>
	
	<%-- 요청 주소에 / 사용시 프로젝트명(폴더명)까지 명시해야한다! --%>
	<form action="/StudyJSP/myServlet3" method="get">
		<input type="submit" value="/StudyJSP/myServlet3 요청(GET)">
	</form>
